...
// Generate unique registration number for users (e.g., STU2025000001, TR2025l3x9y7z12345, HD2025l3x9y7z12345, DN2025l3x9y7z12345)
const generateRegistrationNumber = async (role) => {
...
const fetchHeadmasterByEmail = async (req, res) => {
  try {
    ...
    const user = await User.findOne({ email: email.toLowerCase(), role: 'headmaster', isDeleted: false })
      .select('fullName email phoneNumber school preferences registrationNumber');
