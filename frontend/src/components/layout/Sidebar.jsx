...
const Sidebar = ({ userRole = "student" }) => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            active:
                location.pathname.includes("/student/recent-exams") ||
                location.pathname.includes("/student/submissions"),
            roles: ["student"],
        },
    ];
    ...
    return (
        <>
          ...
          md:translate-x-0 md:static md:min-h-screen md:shadow-none flex flex-col justify-between
        `}
            >
                <div>
                    {(userRole === "dean" ||
                ...
                {/* Navigation Menu */}
                <nav className="mb-40 sm:mt-6 px-2 sm:px-3">
                    {visibleMenuItems.map((item, index) => (
                      ...
                      ${
                          item.active
                             ? "bg-main-blue/10 text-main-blue font-bold border-r-3 border-main-blue shadow-inner"
                    ...
                    `}
                                    ...
                                    >
                                        <div className="flex items-center">
                                            <item.icon
                                                className={`h-5 sm:h-6 w-5 sm:w-6 mr-3 flex-shrink-0 transition-colors duration-300 ${
                                                    item.active
                                                        ? "text-blue-600"
                          ...
                          `}
                                ...
                                <Link
                                    to={item.path}
                                    className={`
                    flex items-center px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-medium rounded-l-[10px] transition-all duration-300
                    ${
                        item.active
                            ? "bg-main-blue/10 text-main-blue font-bold border-r-3 border-main-blue shadow-inner"
                            : "text-gray-700 hover:bg-blue-50 hover:text-blue-600 hover:scale-[1.01]"
                ...
                {/* User Role Indicator */}
                <div className=" bottom-4 left-4 sm:left-6 right-4 sm:right-6">
