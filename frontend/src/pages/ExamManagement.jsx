        ...
        <Layout>
            ...
            >
                        ...
                        <div className="flex gap-3 sm:gap-4 w-full sm:w-auto">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <FaChevronDown
                                        className={`h - 4 sm: h - 5 w - 4 sm: w - 5 text - blue - 600 transition - transform ${
                                            showSubjectDropdown
                                                ? "rotate-180"
                                                : ""
                                        } `}
                ...
                >
                                                ...
                                                classCode={
                                                    ...
                                                    exam.classes.length > 0
                                                        ? exam.classes
                                                              .map(
                                                                  (c) =>
                                                                      c.className || `${c.level}${c.trade?.code || ''}`
                                                              )
                                                              .join(', ')
                                                        : 'No class assigned'
                                                }
                    ...
                    <motion.div
                        className="hidden sm:block w-full sm:w-60"
                        variants={cardVariants}
                    >
                                ...
                                {[
                                    ...
                                    >
                                        <Button
                                            ...
                                            className={`flex items-center gap-2 w-full justify-start px-4 py-2 text-sm sm:text-base ${
                                                filterStatus === status
                                                    ? "bg-blue-600 text-white hover:bg-blue-700"
