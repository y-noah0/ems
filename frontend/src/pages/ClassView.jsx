    ...
    useEffect(() => {
        const fetchClassData = async () => {
            try {
                ...
                const currentClass = await deanService.getClassById(classId);
                ...
                const studentsData = await deanService.getStudentsByClass(
                    classId
                );
                setStudents(studentsData);

                // Fetch subjects for this class
                const subjectsData = await adminService.getSubjectsByClass(
                    classId
                );
            ...
            <div className="mb-6 flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-900">
                    {loading
                        ? "Loading..."
                        : classData
                        ? `Class: ${classData.level} ${classData.trade.code}`
                        : "Class Not Found"}
                </h1>
